...
export type AllocationDto = {
    ...
    rewardRate: AllocationRewardRateDto;
    /**
 ...
 */
export type TransactionDtoUnsignedTransaction = string | { [key: string]: unknown };

/**
 * Human-readable breakdown of the transaction for display purposes
 * @nullable
 */
export type TransactionDtoAnnotatedTransaction = { [key: string]: unknown } | null | null;

/**
 * Detailed transaction data for client-side validation or simulation
 * @nullable
 */
export type TransactionDtoStructuredTransaction = { [key: string]: unknown } | null | null;
...
export type ActionDto = {
    ...
    rawArguments: ActionArgumentsDto;
 ...
 * @nullable
 */
export type ProviderDtoTvlUsd = { [key: string]: unknown } | null | null;
