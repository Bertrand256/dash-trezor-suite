        ...
        'Compare all offers functionality',
        {
            annotation: createTestAnnotation({
                ...
                steps: [
                    ...
                    'Interact with an Offer:',
                    ' - Expand offer details (if applicable)',
                    ' - Check breakdown of fees/rates',
                    'Select an Offer:',
                    ' - Click "Get this deal" or similar button',
                    ' - Verify transition to the Provider/Confrimation flow',
                    'Reload/Refresh Offers:',
                    ' - Use "Get more offers" or refresh button if present -> verify offers update',
                ],
