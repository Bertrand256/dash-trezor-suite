...
module.exports = {
    ...
    mac: {
        ...
        artifactName: 'Dash-Trezor-Suite-${version}-mac-${arch}.${ext}',
    ...
    win: {
        ...
        artifactName: 'Dash-Trezor-Suite-${version}-win-${arch}.${ext}',
        target: ['nsis'],
        signDlls: true,
    ...
    linux: {
        ...
        icon: 'build/static/images/desktop/512x512.png',
        artifactName: 'Dash-Trezor-Suite-${version}-linux-${arch}.${ext}',
