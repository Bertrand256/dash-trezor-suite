...
-   [device events](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/events/device.ts)
-   [blockchain events](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/events/blockchain.ts)
-   [transport events](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/events/transport.ts)
