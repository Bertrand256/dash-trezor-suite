    ...
    return fetch(
        ...
        .then(content => {
            ...
            content = content.replace(
                /([a-f0-9]{7,10})([),])/g,
                `[$1](https://github.com/Bertrand256/dash-trezor-suite/commit/$1)$2`,
            );
...
export const Changelog = () => {
    ...
    if (error) return <Callout>
        <MarkdownCustom>An error occurred while loading the changelog. Please [view it on GitHub](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/CHANGELOG.md).</MarkdownCustom>
    </Callout>;
    ...
    return (
        <>
            ...
            <CollapsibleBox heading="What is a Canary Release?" margin={{ top: spacings.md }}>
                ...
                <MarkdownCustom>
                    **Feedback Opportunity**: Using canary releases allows you to provide feedback on new features and fixes, influencing the final stable release and ensuring it works smoothly with your application. If you encounter any issue, bug, or incompatibility introduced in a Canary release, report it by creating [a new issue in our repository](https://github.com/Bertrand256/dash-trezor-suite/issues/new/choose).
                </MarkdownCustom>
            </CollapsibleBox>
