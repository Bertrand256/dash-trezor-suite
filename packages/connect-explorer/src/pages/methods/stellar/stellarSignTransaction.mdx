...
export const paramDescriptions = {
    ...
    transaction:
        'type of [StellarTransaction](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/stellar/index.ts)',
};
...
To transform `StellarSDK.Transaction` object into `TrezorConnect.StellarTransaction`, install [@trezor/connect-plugin-stellar](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-plugin-stellar) into your project.
...
[StellarSignedTx type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/stellar/index.ts)
