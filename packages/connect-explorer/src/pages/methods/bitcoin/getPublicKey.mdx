...
export const paramDescriptions = {
    ...
    coin: 'determines network definition specified in [coins.json](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect-common/files/coins.json) file. Coin `shortcut`, `name` or `label` can be used. If `coin` is not set API will try to get network definition from `path`.',
...
[HDNodeResponse type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/getPublicKey.ts)
