...
export const paramDescriptions = {
    coin:
        '> Determines network definition specified in [coins.json](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect-common/files/coins.json) file.\n' +
        '> Coin `shortcut`, `name` or `label` can be used.\n',
    inputs: 'of [PROTO.TxInputType](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts)',
    outputs:
        'of [PROTO.TxOutputType](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts)',
    paymentRequests:
        'of [PROTO.TxAckPaymentRequest](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts). See [SLIP-24](https://github.com/satoshilabs/slips/blob/slip24/slip-0024.md)',
    refTxs:
        'of [RefTransaction](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/bitcoin/index.ts).\n' +
...
[SignTransaction type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/bitcoin/index.ts)
...
[SignedTransaction type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/bitcoin/index.ts)
