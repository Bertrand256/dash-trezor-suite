...
export const UsingPathSchema = Type.Object({
    ...
    coin: Type.String({
        description:
            'determines network definition specified in [coins.json](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect-common/files/coins.json) file. Coin `shortcut`, `name` or `label` can be used.',
    }),
});
...
[AccountInfo type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/account.ts)
