...
export const paramDescriptions = {
    ...
    coin: 'determines network definition specified in [coins.json](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect-common/files/coins.json) file. Coin `shortcut`, `name` or `label` can be used.',
...
The result, internally called [`PrecomposedTransaction`](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/composeTransaction.ts) is a set of params that can be used in [signTransaction method](signTransaction.md#params) afterwards.
...
[SignedTransaction type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/composeTransaction.ts)
...
For more examples see [composeTransaction fixtures](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/e2e/__fixtures__/composeTransaction.ts)

### Additional notes

-   [1] `UI.SELECT_ACCOUNT` and `UI.SELECT_FEE` events are emitted when using `trusted mode`
-   [2] Account utxo selection, fee and change calculation is performed by [@trezor/utxo-lib](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/utxo-lib/src/compose) module
