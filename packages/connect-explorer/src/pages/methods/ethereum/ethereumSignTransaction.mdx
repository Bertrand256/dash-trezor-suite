...
export const paramDescriptions = {
    ...
    transaction:
        'type of [`EthereumTransactionEIP1559`](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ethereum/index.ts)`|`[`EthereumSignTransaction`](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ethereum/index.ts) "0x" prefix for each field is optional',
    chunkify:
...
[EthereumSignedTx type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ethereum/index.ts)
