...
export const paramDescriptions = {
    ...
    data: 'type of [`EthereumSignTypedDataMessage`](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ethereum/index.ts)`. A JSON Schema definition can be found in the [EIP-712 spec](https://eips.ethereum.org/EIPS/eip-712).',
    metamask_v4_compat:
...
[EthereumMessageSignature type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts)
