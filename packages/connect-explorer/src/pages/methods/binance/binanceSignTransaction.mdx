...
export const paramDescriptions = {
    ...
    transaction:
        'type of [BinanceSDKTransaction](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/binance/index.ts)',
    chunkify:
...
[BinanceSignedTx type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts)
