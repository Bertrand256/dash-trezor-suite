...
export const paramDescriptions = {
    ...
    transaction:
        'type of [RippleTransaction](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ripple/index.ts)',
    chunkify:
...
[RippleSignedTx type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/ripple/index.ts)
