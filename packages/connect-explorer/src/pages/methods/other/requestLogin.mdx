...
[Login type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/requestLogin.ts)
...
-   [**C#**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.cs)
-   [**Javascript**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.js)
-   [**PHP**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.php)
-   [**Python**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.py)
-   [**Ruby**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.rb)
-   [**Go**](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/docs/packages/connect/methods/server/server.go)
