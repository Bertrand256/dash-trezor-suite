...
export const paramDescriptions = {
    ...
    branch: '',
    operation:
        'type of [TezosOperation](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/types/api/tezos/index.ts)',
    chunkify:
...
[TezosSignedTx type](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/protobuf/src/messages.ts)
