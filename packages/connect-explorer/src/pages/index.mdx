...
<SectionCard>
    <SdkHeading className='nx-text-slate-900 dark:nx-text-slate-100'>
        ...
        <Button
            ...
            size="small"
            icon="github"
            href="https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect"
            target="_blank">
            View on Github
        </Button>
    </SdkHeading>
    ...
    <SdkContainer>
        ...
        <ExamplesAside>
            ...
            - [node](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/node)
            - [electron in main layer](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/electron-main-process)
            - [Trezor Suite (desktop) electron app](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/suite-desktop/README.md)
        </ExamplesAside>
    </SdkContainer>
...
<SectionCard>
    <SdkHeading className='nx-text-slate-900 dark:nx-text-slate-100'>
        ...
        <Button
            ...
            size="small"
            icon="github"
            href="https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-web"
            target="_blank">
            View on Github
        </Button>
    </SdkHeading>
    ...
    <SdkContainer>
        ...
        <ExamplesAside>
            <ExampleHeading>Examples:</ExampleHeading>
            -   [web app](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/browser-inline-script)
            -   [web extension mv2 (foreground or background)](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/webextension-mv2)
            -   [web extension mv3 (foreground)](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/webextension-mv3)
            -   [electron in renderer layer with popup](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/electron-renderer-with-popup)
        </ExamplesAside>
    </SdkContainer>
    <CollapsibleBox heading="Quick start manual" margin={{ top: spacings.md }}>
            <Steps>
...
<SectionCard>
    <SdkHeading className='nx-text-slate-900 dark:nx-text-slate-100'>
        ...
        <Button
            ...
            size="small"
            icon="github"
            href="https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-webextension"
            target="_blank">
            View on Github
        </Button>
    </SdkHeading>
    ...
    <SdkContainer>
        ...
        <ExamplesAside>
            <ExampleHeading>Examples:</ExampleHeading>
            - [Simple example](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/webextension-mv3-sw)
            - [Example with Webpack, TS](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/webextension-mv3-sw-ts)
            - [Connect Explorer example](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-explorer/src-webextension)
        </ExamplesAside>
    </SdkContainer>
        ...
        <CollapsibleBox heading="Quick start manual" margin={{ top: spacings.md }}>
            <Steps>
                ...
                To ensure your extension is displayed with its name rather than its ID, you need to open a Pull Request to include it in the `knownHosts` section of [our configuration file](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/connect/src/data/config.ts#L17).
...
<SectionCard>
    <SdkHeading className='nx-text-slate-900 dark:nx-text-slate-100'>
        ...
        <Button
            ...
            size="small"
            icon="githubLogoAlt"
            href="https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-mobile"
            target="_blank">
            View on Github
        </Button>
    </SdkHeading>
    ...
    <SdkContainer>
        ...
        <ExamplesAside>
            <ExampleHeading>Examples:</ExampleHeading>
            - [Expo App example](https://github.com/Bertrand256/dash-trezor-suite/tree/develop/packages/connect-examples/mobile-expo)
        </ExamplesAside>
    </SdkContainer>
