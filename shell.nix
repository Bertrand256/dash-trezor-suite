...
in
  stdenvNoCC.mkDerivation {
    ...
    buildInputs = [
      ...
      shellcheck
      vips
    ] ++ lib.optional (!useAndroid) jre
      ++ lib.optionals useAndroid ([ androidEnv.jdk androidEnv.androidSdk ] ++ androidEnv.extraPackages)
    ...
    shellHook = ''
     ...
     '' + lib.optionalString useAndroid (androidEnv.nixLdHook)
