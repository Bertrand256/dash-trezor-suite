...
To make your life easier use [FiatValue](https://github.com/Bertrand256/dash-trezor-suite/blob/develop/packages/suite/src/components/suite/FiatValue/index.tsx) component.
